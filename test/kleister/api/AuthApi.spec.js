...
(function (root, factory) {
  ...
  describe('AuthApi', function () {
    ...
    describe('refreshAuth', function () {
      it('should call refreshAuth successfully', function (done) {
        // uncomment below and update the code to test refreshAuth
        // instance.refreshAuth(function(error) {
        //  if (error) throw error;
        // expect().to.be();
        // });
        done()
    ...
    describe('verifyAuth', function () {
      it('should call verifyAuth successfully', function (done) {
        // uncomment below and update the code to test verifyAuth
        // instance.verifyAuth(function(error) {
        //  if (error) throw error;
        // expect().to.be();
        // });
        done()
