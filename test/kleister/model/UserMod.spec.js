...
(function (root, factory) {
  ...
  describe('UserMod', function () {
    it('should create an instance of UserMod', function () {
      // uncomment below and update the code to test UserMod
      // var instane = new Kleister.UserMod();
      // expect(instance).to.be.a(Kleister.UserMod);
    })
