...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.TeamPackParams()
  })
  ...
  describe('TeamPackParams', function () {
    it('should create an instance of TeamPackParams', function () {
      // uncomment below and update the code to test TeamPackParams
