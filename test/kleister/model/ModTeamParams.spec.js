...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.ModTeamParams()
  })
  ...
  describe('ModTeamParams', function () {
    it('should create an instance of ModTeamParams', function () {
      // uncomment below and update the code to test ModTeamParams
      // var instane = new Kleister.ModTeamParams();
      // expect(instance).to.be.a(Kleister.ModTeamParams);
    })
