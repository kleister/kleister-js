...
(function (root, factory) {
  ...
  describe('Forge', function () {
    it('should create an instance of Forge', function () {
      // uncomment below and update the code to test Forge
      // var instane = new Kleister.Forge();
      // expect(instance).to.be.a(Kleister.Forge);
    })
