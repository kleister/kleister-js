...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.ModUserParams()
  })
  ...
  describe('ModUserParams', function () {
    it('should create an instance of ModUserParams', function () {
      // uncomment below and update the code to test ModUserParams
      // var instane = new Kleister.ModUserParams();
      // expect(instance).to.be.a(Kleister.ModUserParams);
    })
