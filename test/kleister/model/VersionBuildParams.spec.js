...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.VersionBuildParams()
  })
  ...
  describe('VersionBuildParams', function () {
    it('should create an instance of VersionBuildParams', function () {
      // uncomment below and update the code to test VersionBuildParams
