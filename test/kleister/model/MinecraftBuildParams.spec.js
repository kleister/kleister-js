...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.MinecraftBuildParams()
  })
  ...
  describe('MinecraftBuildParams', function () {
    it('should create an instance of MinecraftBuildParams', function () {
      // uncomment below and update the code to test MinecraftBuildParams
