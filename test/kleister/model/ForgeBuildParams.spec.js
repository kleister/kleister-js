...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.ForgeBuildParams()
  })
  ...
  describe('ForgeBuildParams', function () {
    it('should create an instance of ForgeBuildParams', function () {
      // uncomment below and update the code to test ForgeBuildParams
