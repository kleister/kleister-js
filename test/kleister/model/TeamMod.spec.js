...
(function (root, factory) {
  ...
  describe('TeamMod', function () {
    it('should create an instance of TeamMod', function () {
      // uncomment below and update the code to test TeamMod
      // var instane = new Kleister.TeamMod();
      // expect(instance).to.be.a(Kleister.TeamMod);
    })
    ...
    it('should have the property modId (base name: "mod_id")', function () {
      // uncomment below and update the code to test the property modId
      // var instane = new Kleister.TeamMod();
      // expect(instance).to.be();
    })
