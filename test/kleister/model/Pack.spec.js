...
(function (root, factory) {
  ...
  describe('Pack', function () {
    it('should create an instance of Pack', function () {
      ...
      // var instane = new Kleister.Pack();
      // expect(instance).to.be.a(Kleister.Pack);
    })
    ...
    it('should have the property recommendedId (base name: "recommended_id")', function () {
      // uncomment below and update the code to test the property recommendedId
      // var instane = new Kleister.Pack();
      // expect(instance).to.be();
    })

    it('should have the property latestId (base name: "latest_id")', function () {
      // uncomment below and update the code to test the property latestId
      // var instane = new Kleister.Pack();
      // expect(instance).to.be();
    })
