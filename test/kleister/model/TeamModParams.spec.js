...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.TeamModParams()
  })
  ...
  describe('TeamModParams', function () {
    it('should create an instance of TeamModParams', function () {
      // uncomment below and update the code to test TeamModParams
      // var instane = new Kleister.TeamModParams();
      // expect(instance).to.be.a(Kleister.TeamModParams);
    })
