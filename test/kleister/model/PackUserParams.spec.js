...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.PackUserParams()
  })
  ...
  describe('PackUserParams', function () {
    it('should create an instance of PackUserParams', function () {
      // uncomment below and update the code to test PackUserParams
      // var instane = new Kleister.PackUserParams();
      // expect(instance).to.be.a(Kleister.PackUserParams);
    })
