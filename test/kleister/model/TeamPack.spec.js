...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.TeamPack()
  })
  ...
  describe('TeamPack', function () {
    it('should create an instance of TeamPack', function () {
      // uncomment below and update the code to test TeamPack
      // var instane = new Kleister.TeamPack();
      // expect(instance).to.be.a(Kleister.TeamPack);
    })
