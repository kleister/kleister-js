...
(function (root, factory) {
  ...
  describe('Build', function () {
    it('should create an instance of Build', function () {
      ...
      // var instane = new Kleister.Build();
      // expect(instance).to.be.a(Kleister.Build);
    })
    ...
    it('should have the property minecraftId (base name: "minecraft_id")', function () {
      // uncomment below and update the code to test the property minecraftId
      // var instane = new Kleister.Build();
      // expect(instance).to.be();
    })

    it('should have the property forgeId (base name: "forge_id")', function () {
      // uncomment below and update the code to test the property forgeId
      // var instane = new Kleister.Build();
      // expect(instance).to.be();
    })
    ...
    it('should have the property minJava (base name: "min_java")', function () {
      // uncomment below and update the code to test the property minJava
      // var instane = new Kleister.Build();
      // expect(instance).to.be();
    })

    it('should have the property minMemory (base name: "min_memory")', function () {
