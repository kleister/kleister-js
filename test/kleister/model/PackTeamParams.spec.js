...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Kleister.PackTeamParams()
  })
  ...
  describe('PackTeamParams', function () {
    it('should create an instance of PackTeamParams', function () {
      // uncomment below and update the code to test PackTeamParams
      // var instane = new Kleister.PackTeamParams();
      // expect(instance).to.be.a(Kleister.PackTeamParams);
    })
