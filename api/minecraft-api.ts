...
export const MinecraftApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    appendMinecraftToBuild: async (
      minecraftId: string,
      minecraftBuild: MinecraftBuildParams,
     ...
     * @throws {RequiredError}
     */
    searchMinecrafts: async (
      minecraftId: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'minecraftId' is not null or undefined
      assertParamExists("searchMinecrafts", "minecraftId", minecraftId);
      const localVarPath = `/minecraft/{minecraft_id}`.replace(
        `{${"minecraft_id"}}`,
        encodeURIComponent(String(minecraftId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appendMinecraftToBuild(
          minecraftId,
          minecraftBuild,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.searchMinecrafts(minecraftId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateMinecraft(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
...
export const MinecraftApiFactory = function (
  ...
  return {
    ...
    appendMinecraftToBuild(
      ...
      return localVarFp
        .appendMinecraftToBuild(minecraftId, minecraftBuild, options)
    ...
    deleteMinecraftFromBuild(
      ...
      return localVarFp
        .deleteMinecraftFromBuild(minecraftId, minecraftBuild, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    listMinecraftBuilds(
      ...
      return localVarFp
        .listMinecraftBuilds(minecraftId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    searchMinecrafts(
      ...
      return localVarFp
        .searchMinecrafts(minecraftId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class MinecraftApi extends BaseAPI {
  ...
  public appendMinecraftToBuild(
    requestParameters: MinecraftApiAppendMinecraftToBuildRequest,
    options?: AxiosRequestConfig
  ) {
    return MinecraftApiFp(this.configuration)
      .appendMinecraftToBuild(
        requestParameters.minecraftId,
        requestParameters.minecraftBuild,
        options
      )
  ...
  public listMinecraftBuilds(
    ...
    return MinecraftApiFp(this.configuration)
      .listMinecraftBuilds(requestParameters.minecraftId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public searchMinecrafts(
    requestParameters: MinecraftApiSearchMinecraftsRequest,
    options?: AxiosRequestConfig
  ) {
    return MinecraftApiFp(this.configuration)
      .searchMinecrafts(requestParameters.minecraftId, options)
      .then((request) => request(this.axios, this.basePath));
  }
