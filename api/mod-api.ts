...
export const ModApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    appendModToTeam: async (
      modId: string,
      modTeam: ModTeamParams,
     ...
     * @throws {RequiredError}
     */
    appendModToUser: async (
      modId: string,
      modUser: ModUserParams,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'modId' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    appendVersionToBuild: async (
      modId: string,
      versionId: string,
      versionBuild: VersionBuildParams,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'modId' is not null or undefined
...
export const ModApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.appendModToTeam(
        modId,
        modTeam,
        options
      );
    ...
    async appendModToUser(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GeneralError>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.appendModToUser(
        modId,
        modUser,
        options
      );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appendVersionToBuild(
          modId,
          versionId,
          versionBuild,
          options
    ...
    async listMods(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Mod>>
    > {
    ...
    async listVersionBuilds(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<BuildVersion>>
    > {
      const localVarAxiosArgs =
...
export const ModApiFactory = function (
  ...
  return {
    ...
    appendModToTeam(
      ...
      return localVarFp
        .appendModToTeam(modId, modTeam, options)
    ...
    appendModToUser(
      ...
      return localVarFp
        .appendModToUser(modId, modUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    appendVersionToBuild(
      ...
      return localVarFp
        .appendVersionToBuild(modId, versionId, versionBuild, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createVersion(
      ...
      return localVarFp
        .createVersion(modId, version, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteModFromTeam(
      ...
      return localVarFp
        .deleteModFromTeam(modId, modTeam, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteModFromUser(
      ...
      return localVarFp
        .deleteModFromUser(modId, modUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteVersion(
      ...
      return localVarFp
        .deleteVersion(modId, versionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteVersionFromBuild(
      ...
      return localVarFp
        .deleteVersionFromBuild(modId, versionId, versionBuild, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    listVersionBuilds(
      ...
      return localVarFp
        .listVersionBuilds(modId, versionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    permitModTeam(
      ...
      return localVarFp
        .permitModTeam(modId, modTeam, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    permitModUser(
      ...
      return localVarFp
        .permitModUser(modId, modUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    showVersion(
      ...
      return localVarFp
        .showVersion(modId, versionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateVersion(
      ...
      return localVarFp
        .updateVersion(modId, versionId, version, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ModApi extends BaseAPI {
   ...
   * @memberof ModApi
   */
  public appendModToTeam(
    requestParameters: ModApiAppendModToTeamRequest,
    options?: AxiosRequestConfig
  ) {
    return ModApiFp(this.configuration)
      .appendModToTeam(
        requestParameters.modId,
        requestParameters.modTeam,
        options
      )
   ...
   * @memberof ModApi
   */
  public appendModToUser(
    requestParameters: ModApiAppendModToUserRequest,
    options?: AxiosRequestConfig
  ) {
    return ModApiFp(this.configuration)
      .appendModToUser(
        requestParameters.modId,
        requestParameters.modUser,
        options
      )
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public appendVersionToBuild(
    requestParameters: ModApiAppendVersionToBuildRequest,
    options?: AxiosRequestConfig
  ) {
    return ModApiFp(this.configuration)
      .appendVersionToBuild(
        ...
        requestParameters.versionBuild,
        options
      )
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listModTeams(
    ...
    return ModApiFp(this.configuration)
      .listModTeams(requestParameters.modId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listModUsers(
    ...
    return ModApiFp(this.configuration)
      .listModUsers(requestParameters.modId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listVersions(
    ...
    return ModApiFp(this.configuration)
      .listVersions(requestParameters.modId, options)
      .then((request) => request(this.axios, this.basePath));
  }
