...
export const PackApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    appendBuildToVersion: async (
      packId: string,
      buildId: string,
      buildVersion: BuildVersionParams,
     ...
     * @throws {RequiredError}
     */
    appendPackToTeam: async (
      packId: string,
      packTeam: PackTeamParams,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'packId' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    appendPackToUser: async (
      packId: string,
      packUser: PackUserParams,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'packId' is not null or undefined
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appendBuildToVersion(
          packId,
          buildId,
          buildVersion,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appendPackToTeam(
          packId,
          packTeam,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appendPackToUser(
          packId,
          packUser,
          options
        );
    ...
    async listPacks(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pack>>
    > {
...
export const PackApiFactory = function (
  ...
  return {
    ...
    appendBuildToVersion(
      ...
      return localVarFp
        .appendBuildToVersion(packId, buildId, buildVersion, options)
    ...
    appendPackToTeam(
      ...
      return localVarFp
        .appendPackToTeam(packId, packTeam, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    appendPackToUser(
      ...
      return localVarFp
        .appendPackToUser(packId, packUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createBuild(
      ...
      return localVarFp
        .createBuild(packId, build, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteBuild(
      ...
      return localVarFp
        .deleteBuild(packId, buildId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteBuildFromVersion(
      ...
      return localVarFp
        .deleteBuildFromVersion(packId, buildId, buildVersion, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deletePackFromTeam(
      ...
      return localVarFp
        .deletePackFromTeam(packId, packTeam, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deletePackFromUser(
      ...
      return localVarFp
        .deletePackFromUser(packId, packUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    listBuildVersions(
      ...
      return localVarFp
        .listBuildVersions(packId, buildId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    permitPackTeam(
      ...
      return localVarFp
        .permitPackTeam(packId, packTeam, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    permitPackUser(
      ...
      return localVarFp
        .permitPackUser(packId, packUser, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    showBuild(
      ...
      return localVarFp
        .showBuild(packId, buildId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateBuild(
      ...
      return localVarFp
        .updateBuild(packId, buildId, build, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updatePack(packId: string, pack: Pack, options?: any): AxiosPromise<Pack> {
      return localVarFp
        .updatePack(packId, pack, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class PackApi extends BaseAPI {
  ...
  public appendBuildToVersion(
    requestParameters: PackApiAppendBuildToVersionRequest,
    options?: AxiosRequestConfig
  ) {
    return PackApiFp(this.configuration)
      .appendBuildToVersion(
        ...
        requestParameters.buildVersion,
        options
      )
   ...
   * @memberof PackApi
   */
  public appendPackToTeam(
    requestParameters: PackApiAppendPackToTeamRequest,
    options?: AxiosRequestConfig
  ) {
    return PackApiFp(this.configuration)
      .appendPackToTeam(
        requestParameters.packId,
        requestParameters.packTeam,
        options
      )
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof PackApi
   */
  public appendPackToUser(
    requestParameters: PackApiAppendPackToUserRequest,
    options?: AxiosRequestConfig
  ) {
    return PackApiFp(this.configuration)
      .appendPackToUser(
        requestParameters.packId,
        requestParameters.packUser,
        options
      )
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listBuilds(
    ...
    return PackApiFp(this.configuration)
      .listBuilds(requestParameters.packId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listPackTeams(
    ...
    return PackApiFp(this.configuration)
      .listPackTeams(requestParameters.packId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public listPackUsers(
    ...
    return PackApiFp(this.configuration)
      .listPackUsers(requestParameters.packId, options)
      .then((request) => request(this.axios, this.basePath));
  }
