 ...
 * @module kleister/model/AuthVerify
 * @version 1.0.0-alpha1
 */
class AuthVerify {
  /**
     * Constructs a new <code>AuthVerify</code>.
     * @alias module:kleister/model/AuthVerify
  ...
  /**
     ...
     * @param {module:kleister/model/AuthVerify} obj Optional instance to populate.
     * @return {module:kleister/model/AuthVerify} The populated <code>AuthVerify</code> instance.
     */
