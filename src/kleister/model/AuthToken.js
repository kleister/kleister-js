 ...
 * @module kleister/model/AuthToken
 * @version 1.0.0-alpha1
 */
class AuthToken {
  /**
     * Constructs a new <code>AuthToken</code>.
     * @alias module:kleister/model/AuthToken
     * @param token {String}
  ...
  /**
     ...
     * @param {module:kleister/model/AuthToken} obj Optional instance to populate.
     * @return {module:kleister/model/AuthToken} The populated <code>AuthToken</code> instance.
     */
