 ...
 * @module kleister/model/TeamUserParams
 * @version 1.0.0-alpha1
 */
class TeamUserParams {
  /**
     * Constructs a new <code>TeamUserParams</code>.
     * @alias module:kleister/model/TeamUserParams
     * @param user {String}
     * @param perm {module:kleister/model/TeamUserParams.PermEnum}
     */
  ...
  /**
     ...
     * @param {module:kleister/model/TeamUserParams} obj Optional instance to populate.
     * @return {module:kleister/model/TeamUserParams} The populated <code>TeamUserParams</code> instance.
     */
...
/**
 * @member {module:kleister/model/TeamUserParams.PermEnum} perm
 */
