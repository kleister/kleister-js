 ...
 * @module kleister/model/User
 * @version 1.0.0-alpha1
 */
class User {
  /**
     * Constructs a new <code>User</code>.
     * @alias module:kleister/model/User
  ...
  /**
     ...
     * @param {module:kleister/model/User} obj Optional instance to populate.
     * @return {module:kleister/model/User} The populated <code>User</code> instance.
     */
