 ...
 * @module kleister/model/TeamUser
 * @version 1.0.0-alpha1
 */
class TeamUser {
  /**
     * Constructs a new <code>TeamUser</code>.
     * @alias module:kleister/model/TeamUser
     * @param teamId {String}
     * @param userId {String}
     * @param perm {module:kleister/model/TeamUser.PermEnum}
     */
  ...
  /**
     ...
     * @param {module:kleister/model/TeamUser} obj Optional instance to populate.
     * @return {module:kleister/model/TeamUser} The populated <code>TeamUser</code> instance.
     */
...
/**
 * @member {module:kleister/model/TeamUser.PermEnum} perm
 */
