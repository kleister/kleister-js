 ...
 * @module kleister/model/Team
 * @version 1.0.0-alpha1
 */
class Team {
  /**
     * Constructs a new <code>Team</code>.
     * @alias module:kleister/model/Team
     * @param name {String}
     */
  constructor (name) {
  ...
  /**
     ...
     * @param {module:kleister/model/Team} obj Optional instance to populate.
     * @return {module:kleister/model/Team} The populated <code>Team</code> instance.
     */
