 ...
 * @module kleister/model/ValidationError
...
class ValidationError {
  /**
     ...
     * @alias module:kleister/model/ValidationError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:kleister/model/ValidationError} obj Optional instance to populate.
     * @return {module:kleister/model/ValidationError} The populated <code>ValidationError</code> instance.
     */
...
/**
 * @member {Array.<module:kleister/model/ValidationErrorErrors>} errors
 */
