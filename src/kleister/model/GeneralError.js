 ...
 * @module kleister/model/GeneralError
...
class GeneralError {
  /**
     ...
     * @alias module:kleister/model/GeneralError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:kleister/model/GeneralError} obj Optional instance to populate.
     * @return {module:kleister/model/GeneralError} The populated <code>GeneralError</code> instance.
     */
