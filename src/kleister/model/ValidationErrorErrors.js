 ...
 * @module kleister/model/ValidationErrorErrors
 * @version 1.0.0-alpha1
 */
class ValidationErrorErrors {
  /**
     * Constructs a new <code>ValidationErrorErrors</code>.
     * @alias module:kleister/model/ValidationErrorErrors
     */
  constructor () {
  ...
  /**
     ...
     * @param {module:kleister/model/ValidationErrorErrors} obj Optional instance to populate.
     * @return {module:kleister/model/ValidationErrorErrors} The populated <code>ValidationErrorErrors</code> instance.
     */
