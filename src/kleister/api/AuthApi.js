...
/**
* Auth service.
* @module kleister/api/AuthApi
* @version 1.0.0-alpha1
*/
export default class AuthApi {
  /**
    * Constructs a new AuthApi.
    * @alias module:kleister/api/AuthApi
    * @class
  ...
  /**
     ...
     * @param {module:kleister/model/AuthLogin} authLogin The credentials to authenticate
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:kleister/model/AuthVerify} and HTTP response
     */
  ...
  /**
     * Verify validity for an authentication token
     * @param {String} token A token that have to be checked
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:kleister/model/AuthVerify}
     */
  verifyAuth (token) {
